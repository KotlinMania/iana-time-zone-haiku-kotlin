...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `IanaTimeZoneHaiku.swiftmodule/`
...
//      `import IanaTimeZoneHaiku` above would fail at compile time.
//
//   2. The static archive `libIanaTimeZoneHaiku.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "IanaTimeZoneHaiku" }` and
//      `flattenPackage = "io.github.kotlinmania.ianatimezonehaiku"` configuration in
...
//      via the `IanaTimeZoneHaikuLibrary` product.
//
...
final class IanaTimeZoneHaikuExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "IanaTimeZoneHaiku swift module imported cleanly")
    }
}

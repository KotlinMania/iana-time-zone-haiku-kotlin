...
kotlin {
    ...
    val xcf = XCFramework("IanaTimeZoneHaiku")

    macosArm64 {
        binaries.framework { baseName = "IanaTimeZoneHaiku"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "IanaTimeZoneHaiku"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "IanaTimeZoneHaiku"
        flattenPackage = "io.github.kotlinmania.ianatimezonehaiku"
    }

    android {
        namespace = "io.github.kotlinmania.ianatimezonehaiku"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "iana-time-zone-haiku-kotlin", version.toString())

    pom {
        name.set("iana-time-zone-haiku-kotlin")
    ...
    doFirst {
        ...
        if (sourceFiles.isEmpty()) {
            ...
            sentinelFile.writeText(
                ...
                package io.github.kotlinmania.ianatimezonehaiku.codeql
...
val fullTargetBuildTaskNames = setOf(
    ...
    "assembleIanaTimeZoneHaikuXCFramework",
)
